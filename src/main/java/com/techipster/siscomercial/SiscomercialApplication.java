package com.techipster.siscomercial;
...
public class SiscomercialApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		cat2.getProdutos().addAll(Arrays.asList(po2));
		
		po1.getCategorias().addAll(Arrays.asList(cat1));
		po2.getCategorias().addAll(Arrays.asList(cat1, cat2));
		po3.getCategorias().addAll(Arrays.asList(cat1));
		
		categoriaRepository.saveAll(Arrays.asList(cat1, cat2));
		produtoRepository.saveAll(Arrays.asList(po1, po2, po3));
